...
Uses GPT-4o Vision API for analysis (vision helpers in ai_vision.py)
"""
import logging
...
# Vision helpers extracted to ai_vision.py (v94 audit)
from .ai_vision import analyze_image_with_vision, compare_faces
