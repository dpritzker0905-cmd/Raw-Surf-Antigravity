...
def _no_live_forecast(monkeypatch):
    ...
    # A staged override OUTRANKS every other baseline, so leaving one behind changes what the NEXT
    # test observes. That leak was invisible until this file was split and the order changed.
