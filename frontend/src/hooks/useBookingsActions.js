 ...
 * ✅ Step 1: JSX scan — zero JSX in extraction range
 ...
 * ✅ Step 5: Utility/import scan — apiClient, toast, logger
 * ✅ Step 6: Hook placement — called AFTER all useState declarations
 * ✅ Step 7: Cross-module export — SURFER_ROLES is local const, not needed
 */
import apiClient from '../lib/apiClient';
import { toast } from 'sonner';
import logger from '../utils/logger';

var useBookingsActions = ({
  user,
  updateUser,
  navigate,
  canJoinSessions,
