 ...
 * Extracted from Bookings.js G현 handler logic for the Bookings page.
 * 
 * Extraction checklist (v30):
 * G｀ Step 1: JSX scan G현 zero JSX in extraction range
 ...
 * G｀ Step 5: Utility/import scan G현 apiClient, toast, logger
 * G｀ Step 6: Hook placement G현 called AFTER all useState declarations
 * G｀ Step 7: Cross-module export G현 SURFER_ROLES is local const, not needed
 */
