/**
 * PhotographerHubContent G현 Extracted from SurferSessionHub.js (v79)
 *
 * "Active Duty" console for photographers:
 * 1. Go On-Demand G현 Toggle availability with spot selection
 * 2. Go Live G현 Start active shooting session
 * 3. Other Shooters G현 See who's nearby
 * 4. Scheduled Sessions G현 Today's agenda only
 */
