      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-3 mt-1 flex-wrap">
              ...
              {gallery.session_type && gallery.session_type !== 'manual' && (
                <Badge variant="outline" className={
                  ...
                  {gallery.session_type === 'live' ? 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â¸ Live Session' : 
                   gallery.session_type === 'booking' ? 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¦ Booking' : 
                   gallery.session_type === 'on_demand' ? 'ÃƒÂ¢Ã…Â¡Ã‚Â¡ On-Demand' : gallery.session_type}
                </Badge>
              )}
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  toast.success(willPublish ? 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â¸ Gallery published to your Sessions tab!' : 'Gallery unpublished');
                } catch (err) {
            ...
            {/* Push to Spot Hub ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½ requires linked surf spot AND live session */}
