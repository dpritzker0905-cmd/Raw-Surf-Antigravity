...
export const SessionRosterCard = ({ 
  ...
  const sessionLabel = {
    live: { text: 'Live Session', color: '#10b981', emoji: '=껚+' },
    booking: { text: 'Booking', color: '#3b82f6', emoji: '=껚+' },
    on_demand: { text: 'On-Demand', color: '#f59e0b', emoji: '?' },
    manual: { text: 'Manual', color: '#6b7280', emoji: '=껚+' }
  }[sessionType] || { text: 'Session', color: '#6b7280', emoji: '=껚+' };
            ...
            <div className="flex gap-3 pt-3">
              ...
              <div className="flex-1 space-y-1.5">
                ...
                <div className="flex items-center gap-2 mt-1 flex-wrap">
                  <MiniPill icon={payment_method === 'credits' ? '?' : '=껚+'}
