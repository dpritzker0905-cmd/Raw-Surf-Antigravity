      ...
      <Dialog open={showGalleryPricingModal} onOpenChange={setShowGalleryPricingModal}>
        <DialogContent className="bg-background border-border text-foreground max-h-[90vh] overflow-y-auto max-w-2xl">
          ...
          <div className="space-y-4 py-2">
            ...
            {/* +óGÇ¥Gé¼+óGÇ¥Gé¼+óGÇ¥Gé¼ GALLERY (General) +óGÇ¥Gé¼+óGÇ¥Gé¼+óGÇ¥Gé¼ */}
            ...
            {/* +óGÇ¥Gé¼+óGÇ¥Gé¼+óGÇ¥Gé¼ LIVE SESSION +óGÇ¥Gé¼+óGÇ¥Gé¼+óGÇ¥Gé¼ */}
            ...
            {/* +óGÇ¥Gé¼+óGÇ¥Gé¼+óGÇ¥Gé¼ ON-DEMAND +óGÇ¥Gé¼+óGÇ¥Gé¼+óGÇ¥Gé¼ */}
            ...
            {/* +óGÇ¥Gé¼+óGÇ¥Gé¼+óGÇ¥Gé¼ BOOKING +óGÇ¥Gé¼+óGÇ¥Gé¼+óGÇ¥Gé¼ */}
