...
const LOCAL_NE_LAND_URL = '/ne_110m_land.json';
const CDN_NE_LAND_URL   = 'https://cdn.jsdelivr.net/gh/martynafford/natural-earth-geojson@master/110m/physical/ne_110m_land.json';
