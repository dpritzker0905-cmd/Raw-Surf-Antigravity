...
// ⚠️⚠️ HI IS A STALE CALIBRATION — spans 9.5-40° are a DEAD ZONE where the backend ships a RATED
// grid this function multiplies by ZERO. The 15° ceiling HI was derived from moved 15→40→400
// (2026-07-22/23) the same week the backend began RATING the mid tier. NOT re-tuned: owner call.
// Full evidence, the regime table and the recommended experiment:
//   docs/research/FINDING-2026-08-09-the-rating-band-dead-zone.md
// Pinned by the DEAD ZONE block in WebGLMarineEngine.ratingBandFade.test.js (known-defective by
// design — rewrite it in the same commit that re-tunes HI).
// Levers: __RAW_RATING_SPAN_FADE_LO__ (default 6°, fade starts) / __RAW_RATING_SPAN_FADE_HI__
// (default 9.5° — the RETIRED 15° request-span boundary; see the dead-zone finding above) /
