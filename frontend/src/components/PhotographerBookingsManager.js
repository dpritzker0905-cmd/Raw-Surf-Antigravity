...
export const PhotographerBookingsManager = () => {
  ...
  return (
    <div className={`pb-20 min-h-screen ${mainBgClass} transition-colors duration-300`} data-testid="photographer-bookings-page">
      ...
      <CreateSessionModal {...{ showCreateModal, setShowCreateModal, newBooking, setNewBooking, calendarStep, setCalendarStep, selectedDate, setSelectedDate, selectedTime, setSelectedTime, existingBookedSlots, timeSlots, handleCreateBooking, fetchBookedSlots, resetCreateForm, isDateDisabled, isSlotBooked, isTimeSlotWithinLeadTime, crewMembers, setCrewMembers, newCrewInput, setNewCrewInput, handleAddCrewMember, handleRemoveCrewMember, calculateCrewTotal, calculatePerPersonSplit, generatedSplitLink, generateSplitLink, copySplitLink, user, theme, isLight, isBeach, textPrimaryClass, textSecondaryClass, borderClass, inputBgClass, cardBgClass }} />
      <ParticipantsModal {...{ showParticipantsModal, setShowParticipantsModal, selectedBooking, theme, isLight, textPrimaryClass, textSecondaryClass, borderClass }} />
      <BookingPricingModal {...{ showPricingModal, setShowPricingModal, bookingPricing, setBookingPricing, handleSaveBookingPricing, user, theme, isLight, isBeach, textPrimaryClass, textSecondaryClass, borderClass, inputBgClass, cardBgClass }} />
      <CrewSplitModal {...{ showCrewModal, setShowCrewModal, selectedBooking, crewMembers, setCrewMembers, newCrewInput, setNewCrewInput, handleAddCrewMember, handleRemoveCrewMember, calculateCrewTotal, calculatePerPersonSplit, generatedSplitLink, generateSplitLink, copySplitLink, theme, isLight, textPrimaryClass, textSecondaryClass, borderClass, inputBgClass }} />
      <AvailabilityModal {...{ showAvailabilityModal, setShowAvailabilityModal, availability, setAvailability, newAvailability, setNewAvailability, availabilityView, setAvailabilityView, weeklyGrid, setWeeklyGrid, handleSaveAvailability, handleDeleteAvailability, handleSaveGridAvailability, handleTimePresetSelect, toggleRecurringDay, handleGridCellStart, handleGridCellEnter, handleGridDragEnd, resetAvailabilityForm, isGridDragging, timePresets, weekDays, gridHours, theme, isLight, isBeach, textPrimaryClass, textSecondaryClass, borderClass, inputBgClass, cardBgClass }} />
