              ...
              <div className={`mt-4 p-4 rounded-xl border ${isLight ? 'bg-blue-50 border-blue-200' : 'bg-blue-500/10 border-blue-500/20'}`}>
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <NumericStepper
                    ...
                    value={odPriceStandard}
                    onChange={setOdPriceStandard}
                    min={0}
                    max={500}
                    step={0.5}
                    prefix="$"
