...
const getDefaultCreditUses = (effectiveRole) => {
 ...
 { icon: "=", title: "Competition Entry", description: "Local and regional contests" },
    ...
    return [
 { icon: "Gn+", title: "Travel & Contests", description: "Competition travel expenses" },
 { icon: "G", title: "Pro Equipment", description: "High-performance gear" },
    ];
 ...
 { icon: "=n+", title: "Premium Gear", description: "Top-tier equipment" },
    ];
  }
  return [
 { icon: "=", title: "Gear & Equipment", description: "Boards, wetsuits, and accessories" },
