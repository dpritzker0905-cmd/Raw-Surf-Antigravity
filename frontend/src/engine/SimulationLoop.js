...
export function bindField(field) {
  ...
  if (field.revision !== _lastFieldRevision) {
    ...
    _evolvedField.grid = {
      ...
      swell2Height:   new Float32Array(field.grid.swell2Height),
      swell2Dir:      new Float32Array(field.grid.swell2Dir),
      swell2Period:   new Float32Array(field.grid.swell2Period),
