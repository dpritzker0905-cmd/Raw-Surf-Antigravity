...
* **Qdrant Vector Database**: Connect to the hosted Qdrant Cloud Cluster using the endpoint URL `https://6c70bac3-ef81-4d4f-a0f8-ad53e8f5b266.eu-west-2-0.aws.cloud.qdrant.io:6333` and the API key from the `QDRANT_API_KEY` environment variable (NEVER inline it here -- this file is tracked in a PUBLIC repository; see docs/runbooks/SECURITY-2026-09-19-committed-credentials.md) (verified success v1.18.1) for indexing, cosine similarities, decay scoring, and surfer preference queries.
